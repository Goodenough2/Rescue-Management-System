...
(function() {
  ...
  if (!window.requestAnimationFrame) {
    window.requestAnimationFrame = function(b) {
      var c = (new Date()).getTime(); var f = Math.max(0, 16 - (c - a)); var g = window.setTimeout(function() {
        b(c + f)
      }, f)
      a = c + f
      return g
...
CAV.Vector3 = {
  create: function(a, b, c) {
    ...
    var c = a[0] - b[0]; var d = a[1] - b[1]; var e = a[2] - b[2]
    return c * c + d * d + e * e
...
CAV.Color.prototype = {
  set: function(a, b) {
    var a = a.replace('#', ''); var c = a.length / 3
    ...
    var a = this.hexify(this.rgba[0]); var b = this.hexify(this.rgba[1]); var c = this.hexify(this.rgba[2])
    return this.hex = '#' +
      a + b + c
  }
}

<template>
  <div class="app-container list">
    <div class="toolbar">
      ...
      <el-button v-if="access.create.allow" class="tool tool-create" type="primary" icon="el-icon-create" @click="handleCreate">添加</el-button>
      <el-button v-if="access.delete.allow" class="tool tool-delete" type="danger" icon="el-icon-delete" @click="handleDeletes">批量删除</el-button>
    </div>
    ...
    <el-table ref="listTable" v-loading="loading.list" v-adaptive="{ bottomOffset: 55 }" height="200px" :data="datas" :default-sort="sort" border fit highlight-current-row @sort-change="handleSort">
      ...
      <el-table-column label="备注" prop="remark" :sort-orders="sortOrders" align="center" show-overflow-tooltip />
        ...
        <el-row>
          <el-col :xl="6" :md="12" :sm="24">
            <el-form-item label="备注" prop="remark">
              <el-input v-model="create.models.remark" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-dialog v-loading="loading.update" custom-class="dialog-fullscreen dialog-update" :title="update.dialog.title" :visible.sync="update.dialog.visible" :modal="false" :modal-append-to-body="false" :close-on-click-modal="false">
      <el-form ref="formEdit" :rules="update.rules" :model="update.models" label-position="right" :label-width="update.dialog.labelWidth">
        ...
        <el-row>
          <el-col :xl="6" :md="12" :sm="24">
            <el-form-item label="备注" prop="remark">
              <el-input v-model="update.models.remark" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  data() {
    return {
      access: this.$store.getters.access['SystemManage']['Function'],
      datas: null,
      type: [
        { id: 0, name: '开发人员' },
        { id: 1, name: '管理员' },
      ...
      detail: {
        ...
        models: { name: null, type: null, remark: null }
      },
      create: {

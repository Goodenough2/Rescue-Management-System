...
import * as api from '@/api/consolidation-manage/consolidation'
  ...
  data() {
    return {
      ...
      detail: {
        ...
        models: { good: { id: null, code: null, name: null, specification: null }, goodsColors: { name: null },
          cellType: { name: null }, goodsStorageMode: { name: null }, a: null, b: null, c: null, d: null }
